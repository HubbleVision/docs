...
<div className="api-header">
  <div className="api-info">
    ...
    <span className="api-path">/agent/api/v2/generate-chart</span>
  </div>
  <ApiPlaygroundButton 
    initialApi="text2sql" 
...
<RequestParametersTable apiId="text2sql" endpointId="generate-chart" />
...
```bash
curl -X POST "https://api.hubble-rpc.xyz/agent/api/v2/generate-chart" \
...
// Standard response
const data = await fetch('/agent/api/v2/generate-chart', {
  method: 'POST',
  headers: { 
    'Content-Type': 'application/json',
    'HUBBLE-API-KEY': 'your-api-key'
